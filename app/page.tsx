  ...
  const realSites: Site[] = [
    {
      ...
      name: 'POE2DB',
      url: 'https://poe2db.tw/',
      description: 'Unique, Rare 아이템과 Skill, Passive Tree 종합 데이터베이스',
      category: 'DATABASE',
      korean: true,
      featured: true,
      clickCount: 1250,
    ...
    },
    {
      ...
      description: 'Ascendancy 별 Build 가이드와 Atlas, Mapping 전략',
      category: 'GUIDE',
      korean: false,
      featured: true,
      clickCount: 1890,
    ...
    },
    {
      ...
      description: 'Boss 공략과 Act별 Leveling 가이드',
      category: 'GUIDE',
      korean: false,
      featured: false,
      clickCount: 945,
    ...
    },
    {
      ...
      description: 'POE2 전용 레딧 커뮤니티, 최신 Patch Notes와 Meta 토론',
      category: 'COMMUNITY',
      korean: false,
      featured: false,
      clickCount: 1543,
    ...
    },
    {
      ...
      description: '한국 최대 POE 커뮤니티, Witch, Monk 등 Class별 Build 공유',
      category: 'COMMUNITY',
      korean: true,
      featured: true,
      clickCount: 2145,
